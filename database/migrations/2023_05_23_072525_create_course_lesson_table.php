...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('course_lesson', function (Blueprint $table) {
            ...
            $table->string('lesson_number', 100)->nullable()->collation('utf8_general_ci');
            $table->string('lesson_th', 800)->collation('utf8_general_ci');
            $table->string('lesson_en', 800)->nullable()->collation('utf8_general_ci');
            $table->integer('lesson_id_ref')->nullable();
            $table->string('lesson_status', 1)->collation('utf8_general_ci');
            $table->integer('content_type');
            $table->string('content_path', 500)->nullable()->collation('utf8_general_ci');
            ...
            $table->string('lessondocument', 500)->nullable()->collation('utf8_general_ci');
        });
    }
