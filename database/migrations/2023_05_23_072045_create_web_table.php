...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('web', function (Blueprint $table) {
            ...
            $table->string('web_th', 200)->collation('utf8_general_ci');
            $table->string('web_en', 200)->nullable()->collation('utf8_general_ci');
            ...
            $table->string('web_type', 1)->collation('utf8_general_ci');
            $table->string('web_option', 200)->collation('utf8_general_ci');
