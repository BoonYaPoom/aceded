...
class T0101DPController extends Controller
{
    public function ReportC($department_id)
    {
        $depart = Department::findOrFail($department_id);
        return view('layouts.department.item.data.report2.C.index', compact('depart'));
    }
    public function T0101DP($department_id)
    {
        $depart = Department::findOrFail($department_id);
        ...
        return view('layouts.department.item.data.report2.C.table.t0101dp', compact('month', 'learner', 'provin', 'depart'));
    }
    function P0101DP($department_id)
    {
        $depart = Department::findOrFail($department_id);
        $jsonContent = file_get_contents('javascript/json/_data.json');
        $mms = json_decode($jsonContent, true);
        ...
        return view('layouts.department.item.data.report2.C.table.p0101dp', compact('month', 'learner', 'provin', 'depart'));
    }
}
