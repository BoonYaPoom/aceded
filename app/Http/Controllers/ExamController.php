...
class ExamController extends Controller
{
    ...
    public function exampage($subject_id) {
        ...
        return view('page.manage.sub.exam.index', compact('subs','exams'));
    }
    public function createexam($subject_id) {
        ...
        return view('page.manage.sub.exam.create', compact('subs','ques','typequs','lossen'));
    }
    ...
    public function edit_examform($exam_id) {
      ...
      $typequs = QuestionType::all();
      $lossen = CourseLesson::where('subject_id', $subject_id)->get();
      return view('page.manage.sub.exam.edit', compact('exams','ques','typequs','lossen'));
  }
    ...
    public function pagequess($subject_id){
        ...
        $typequs = QuestionType::all();
        $lossen = CourseLesson::where('subject_id', $subject_id)->get();
        return view('page.manage.sub.exam.pageexam.questionadd',compact('subs','ques','typequs','lossen'));
    }
    public function questionadd($subject_id){
        $subs  = CourseSubject::findOrFail($subject_id);   
        $ques = $subs->QuestiSub()->where('subject_id',$subject_id)->get();

        return view('page.manage.sub.exam.pageexam.import',compact('subs','ques'));
    }
    public function create($subject_id){
        ...
        return view('page.manage.sub.exam.pageexam.create',compact('subs','subject_id','typequs','lossen'));
    }
...
$ques->choice4 = $request->choice4;
    ...
    public function edit($question_id){
      ...
      return view('page.manage.sub.exam.pageexam.edit',compact('typequs','lossen','ques'));
  }
