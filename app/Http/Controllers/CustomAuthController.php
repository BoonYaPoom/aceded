    ...
    public function loginUser(Request $request)
    {
        ...
        if ($user) {
            if (Hash::check($request->password, $user->password)) {
                if ($user->user_role == 1 || $user->user_role == 6 && $user->userstatus == 1 ||$user->user_role == 9 && $user->userstatus == 1 || $user->user_role == 7 && $user->userstatus == 1 || $user->user_role == 8 && $user->userstatus == 1 || $user->user_role == 3 && $user->userstatus == 1) {
