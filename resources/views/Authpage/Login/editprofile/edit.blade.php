                                ...
                                <div class="col-md-9 mb-3">
                                    <div class="custom-control custom-control-inline custom-radio mr-3">
                                        <input type="radio" class="custom-control-input usertypeselect" name="user_type"
                                            id="usertype1" value="1" {{ $data->user_type == 1 ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="usertype1">บุคลากรของสำนักงาน</label>
                                    </div>
                                    <div class="custom-control custom-control-inline custom-radio mr-3">
                                        <input type="radio" class="custom-control-input usertypeselect" name="user_type"
                                            id="usertype2" value="2" {{ $data->user_type == 2 ? 'checked' : '' }}>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9 mb-3">
                                    <input type="text" class="form-control inputuname bg-muted" id="username"
                                        name="username" placeholder="username" value="{{ $data->username }}" minlength="5"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9 mb-3">
                                    <input type="text" class="form-control " id="citizen_id" name="citizen_id"
                                        minlength="13" maxlength="13" value="{{ $data->citizen_id }}"
                                ...
                                <div class="col-md-9 mb-3">
                                    <div class="custom-control custom-control-inline custom-radio">
                                        <input type="radio" class="custom-control-input is-valid" name="gender"
                                            id="male" value="1" {{ $data->gender == 1 ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="male">ชาย</label>
                                    </div>
                                    <div class="custom-control custom-control-inline custom-radio">
                                        <input type="radio" class="custom-control-input " name="gender"
                                            id="female" value="2" {{ $data->gender == 2 ? 'checked' : '' }}>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9 mb-3">
                                    <input type="text" class="form-control " id="firstname" name="firstname"
                                        placeholder="ชื่อ" value="{{ $data->firstname }}" required="">
                                </div>
                            </div>
                            <!-- /form row -->
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9 mb-3">
                                    <input type="text" class="form-control " id="lastname" name="lastname"
                                        placeholder="นามสกุล" value="{{ $data->lastname }}">
                                </div>
                            </div>
                            <!-- /form row -->
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9 mb-3">
                                    <input type="text" class="form-control " id="mobile" name="mobile"
                                        value="{{ $data->mobile }}" placeholder="เบอร์โทรศัพท์มือถือ">
                                </div>
                            </div>
                            <!-- /form row -->
                            ...
                            <div class="form-row " id="set_pos_name">
                                ...
                                <div class="col-md-9 mb-3">
                                    <input type="text" class="form-control " id="pos_name" name="pos_name"
                                        value="{{ $data->pos_name }}" placeholder="ตำแหน่ง">
                                </div>
                            </div>
                            <!--/form row -->
