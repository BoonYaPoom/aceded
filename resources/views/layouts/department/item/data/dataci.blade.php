    ...
    <!-- .page-title-bar -->
      ...
      <div class="page-section">
        ...
        <div class="card card-fluid">
          <!-- .card-header -->
          <div class="card-header bg-muted"><a href="{{route('departmentwmspage')}}" style="text-decoration: underline;">จัดการเว็บ </a>  / <i>		ข้อมูลพื้นฐาน</i></div>
          <!-- .card-body -->
          <div class="card-body">
