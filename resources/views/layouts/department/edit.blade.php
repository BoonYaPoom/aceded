    ...
    <div class="page-inner">
        ...
        <div class="page-section">
            ...
            <div class="card card-fluid">
                ...
                <form action="{{ route('departmentupdate',['department_id' => $depart->department_id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!-- .card-body -->
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name_short_en" disabled placeholder="URL (EN)"
                                 value="{{$depart->name_short_en}}">
                        </div><!-- /.form-group -->
