                ...
                <div class="aside-menu overflow-hidden ps">
                    <nav id="stacked-menu" class="stacked-menu stacked-menu-has-collapsible">
                        <ul class="menu">
                            ...
                            <li class="menu-item {{ Str::startsWith(request()->url(), route('manage')) || request()->is('wms', 'wms/*') ? ' has-active text-info' : '' }}">
                                <a href="{{ route('manage') }}" class="menu-link "><span class="menu-icon fas fa-globe"></span>
                                    <span class="menu-text">จัดการเว็บ</span></a>
                            </li>
                            <li class="menu-item {{ Str::startsWith(request()->url(), route('dls')) || request()->is('dls', 'dls/*') ? ' has-active text-info' : '' }} ">
                                <a href="{{ route('dls') }}" class="menu-link "><span class="menu-icon fas fa-book"></span>
