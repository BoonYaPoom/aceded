...
@section('subject-data')
    <form action="{{ route('storeless', [$depart, 'subject_id' => $subs]) }}" method="post" enctype="multipart/form-data">
        @csrf

        <div class="card-body">
            <!-- .form-group -->
            <div class="form-group">
                <label for="lesson_number">ลำดับ </label> <input type="text" class="form-control" name="lesson_number"
                    placeholder="ลำดับ" value="">
            </div>
            <!-- /.form-group -->
            <!-- .form-group -->
            <div class="form-group">
                <label for="lesson_th">ชื่อเรื่อง (ไทย) <span class="badge badge-warning">Required</span></label>
                <input type="text" class="form-control" id="lesson_th" name="lesson_th" placeholder="ชื่อเรื่อง (ไทย)"
                    required="" value="">
            </div>
            <!-- /.form-group -->
            <!-- .form-group -->
            ...
            <div class="form-group">
                ...
                <textarea class="editor" data-placeholder="สิ่งที่ได้รับจากบทเรียน" data-height="200" name="resultlesson"></textarea>
            </div>
            <!-- /.form-group -->
            <!-- .form-group -->
            <div class="form-group">
                <label class="control-label" for="content_type">รูปแบบบทเรียน(ชนิดสื่อ)</label>
                <select name="content_type" class="form-control" data-toggle="select2" data-placeholder="ชนิดสื่อ"
            ...
            <div class="form-group">
                ...
                <label class="switcher-control switcher-control-success switcher-control-lg">
                    ...
                    <span class="switcher-label-on">ON</span> <span class="switcher-label-off text-red">OFF</span></label>
            </div>
            <!-- /.form-group -->
            <!-- .form-group -->
            <div class="form-group">
