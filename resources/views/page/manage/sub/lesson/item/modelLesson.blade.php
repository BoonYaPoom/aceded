<div id="clientUploadModal-{{ $item->lesson_id }}" class="modal fade" tabindex="-1" user_role="dialog"
    aria-labelledby="clientUploadModalLabel">
                        ...
                        <div class="showcontents card-body text-center">
                            @if ($contentType)
                                @if ($contentType->content_type === 1)
                                    <h1>video</h1> <a href="{{ asset($item->content_path) }}" class="btn "
                                        style="background-color: {{ $depart->color }};" download>ดาวน์โหลดไฟล์</a>
                                    <div class="showcontent show-video">
                                        <video width="80%" id="videoplayer" controls="">
                                            <source src="{{ asset($item->content_path) }}"
                                                alt="{{ $item->content_path }}" type="video/mp4" size="720"
                                                id="sourcevideo" class="sourcecontent">
                                        </video>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="content_path">Choose
                                                files</label>
                                        </div>
                                ...
                                @elseif ($contentType->content_type === 8)
                                    <h1>Image</h1> <a href="{{ asset($item->content_path) }}" class="btn btn-primary"
                                        download>ดาวน์โหลดไฟล์</a>
                                    <div class="showcontent show-image "><img id="sourceimage"
                                            src="{{ asset($item->content_path) }}" alt="{{ $item->content_path }}"
                                            width="80%" height="510px">
                                        <p>{{ $item->content_path }}</p>
                                ...
                                @elseif ($contentType->content_type === 4)
                                    <h1>document</h1><a href="{{ asset($item->content_path) }}" class="btn btn-primary"
                                        download>ดาวน์โหลดไฟล์</a>
                                    <div class="showcontent show-document "><object
                                            data="{{ asset($item->content_path) }}" width="100%" height="200px">
                                            <p>{{ $item->content_path }}</p>
                                ...
                                @elseif ($contentType->content_type === 7)
                                    <h1>sound</h1><a href="{{ asset($item->content_path) }}" class="btn btn-primary"
                                        download>ดาวน์โหลดไฟล์</a>
                                    <div class="showcontent show-sound "><audio id="soundplayer" controls="">
                                            <source src="{{ asset($item->content_path) }}"
                                                alt="{{ $item->content_path }}" type="audio/mp3" id="sourcesounce"
                                                class="sourcecontent">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="content_path" id="content_path"
                                                class="custom-file-input" accept="audio/*">
                                            <label class="custom-file-label" for="content_path">Choose
                                                files</label>
                                        </div>
                                        <div id="progress" class="progress progress-xs rounded-0 fade">
