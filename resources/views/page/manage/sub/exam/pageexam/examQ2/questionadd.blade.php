...
@section('subject-data')
    ...
    <div class="card-body">
        <!-- .table-responsive -->
        <fieldset>
            <legend style="font-size: 20px;">เพิ่มคลังแบบฝึกหัด</legend>
        <div class="form-row mb-3">
            <div class="col-md-9">

            </div>
            <div class="col-md-3">
                <select id="drop2" name="drop2" class="form-control" data-toggle="select2" data-placeholder="เลือกทั้งหมด"
                    data-allow-clear="false" style="width:30%">
                    <option value="0">เลือกทั้งหมด </option>
                    <option value="แบบฝึกหัด ">
                        แบบฝึกหัด
                    </option> 
                </select>
            </div>
                            ...
                            @if ($questionType)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ route('edit_question3', [$depart, $subs, 'question_id' => $item]) }}"><i
        ...
        <header class="page-title-bar">
            ...
            <button type="button" class="btn btn-success btn-floated btn-add"
                onclick="window.location='{{ route('questionform3', [$depart, 'subject_id' => $subs]) }}'"
