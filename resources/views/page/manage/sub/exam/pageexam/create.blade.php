...
@section('subject-data')
    ...
    @endif
    <form action="{{ route('add_questionform', [$depart, 'subject_id' => $subject_id]) }}" method="post"
        enctype="multipart/form-data">
        @csrf

        <!-- .card-header -->
        <div class="card-header bg-muted"> <a href="{{ route('pagequess', [$depart, $subject_id]) }}"
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label class="control-label" for="question_type">ประเภทข้อสอบ</label> <select id="question_type"
                    name="question_type" class="form-control" data-toggle="select2" data-placeholder="ประเภทข้อสอบ"
            ...
            <!-- .form-group -->
            <div class="form-group">
                <label class="control-label" for="lesson_id">หมวดข้อสอบ</label> <select id="lesson_id" name="lesson_id"
                    class="form-control" data-toggle="select2" data-placeholder="หมวดข้อสอบ" data-allow-clear="false">
            ...
            <div id="data1" style="display:none;">
                <div class="form-group qtype1 ">
                    <label class="control-label" for="numchoice">จำนวนตัวเลือก</label> <select id="numchoice"
                        name="numchoice" class="form-control" data-toggle="select2" data-placeholder="จำนวนตัวเลือก"
                        data-allow-clear="false">
                        @for ($i = 2; $i <= 8; $i++)
                            <option value="{{ $i }}">
                                {{ $i }}</option>
                ...
                <div class="row qtype4 ">
                    <div class="col-lg-6">
                        ...
                        <div class="list-group list-group mb-3">
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans1" name="ans1" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 1" data-allow-clear="false">
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans2" name="ans2" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 2" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans3" name="ans3" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 3" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans4" name="ans4" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 4" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans5" name="ans5" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 5" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans6" name="ans6" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 6" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans7" name="ans7" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 7" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans8" name="ans8" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 8" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans9" name="ans9" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 9" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
                            ...
                            <div class="list-group-item">
                                <div class="list-group-item-figure">
                                    <select id="ans10" name="ans10" class="form-control" data-toggle="select2"
                                        data-placeholder="คำตอบ 10" data-allow-clear="false">
                                        <option value="0">เลือกคำตอบ</option>
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}">{{ chr($i + 64) }}</option>
                                        @endfor
            ...
            <div id="data5" style="display:none;">
                ...
                <div class="form-group qtype5 ">
                    ...
                    <div class="list-group list-group mb-3">
                        <div class="list-group-item">
                            <div class="list-group-item-figure">
                                <span class="tile tile-circle bg-success"><i class="fas fa-sort-amount-down"></i></span>
                            </div>
            ...
            <div class="form-group">
                <label for="question_status">สถานะ </label> <label
                    class="switcher-control switcher-control-success switcher-control-lg"><input type="checkbox"
                        class="switcher-input" name="question_status" id="question_status" value="1" checked> <span
