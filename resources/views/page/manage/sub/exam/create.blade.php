                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exam_th" name="exam_th"
                                placeholder="ชื่อข้อสอบ (ไทย)" required="" value="">
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                            <label for="exam_en">ชื่อข้อสอบ (อังกฤษ) </label> <input type="text" class="form-control"
                                id="exam_en" name="exam_en" placeholder="ชื่อข้อสอบ (อังกฤษ)" value="">
                        </div><!-- /.form-group -->
                        <div class="form-row">
                            <!-- grid column -->
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="flatpickr02">เวลาเริ่มต้น</label> <input id="flatpickr02" name="time1"
                                    value="" type="text" class="form-control setdatetime "
                                    data-toggle="flatpickr" data-enable-time="true" data-no-calendar="true"
                                    data-date-format="H:i" data-default-date="" disabled>
                            </div><!-- /grid column -->
                        </div><!-- /.form-row -->
                        <!-- .form-row -->
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="flatpickr03">วันที่ สิ้นสุด</label> <input id="flatpickr03" name="date2"
                                    value="" type="text" class="form-control setdatetime "
                                    data-toggle="flatpickr" disabled>
                            </div><!-- /grid column -->
                            <!-- /grid column -->
                            <div class="col-md-6 mb-3">
