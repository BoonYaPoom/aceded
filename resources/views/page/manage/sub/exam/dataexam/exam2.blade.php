    ...
    <table id="datatable2" class="table w3-hoverable">
        ...
        <thead>
            <tr class="bg-infohead">
                ...
                <th class="align-middle" style="width:70%"> รายการแบบฝึกหัด </th>
                <th class="align-middle" style="width:10%"> สถานะ </th>
                <th class="text-center" style="width:10%"> กระทำ </th>
            </tr>
        </thead><!-- /thead -->
        <tbody>
            @php
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @if (in_array($examtem->exam_type, [1, 2]))
                            <a href="{{ route('edit_examform', [$depart, $subs, 'exam_id' => $examtem]) }}"><i
