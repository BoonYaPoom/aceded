...
@section('contentdepartment')
    ...
    <form action="{{ route('update_examform', ['exam_id' => $exams]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="page-inner">
            ...
            <div class="page-section">
                    ...
                    <div class="card-body">
                        ...
                        <div class="section-block text-center text-sm-left">
                            ...
                            <div class="visual-picker visual-picker has-peek">
                                ...
                                <label class="visual-picker-figure" for="exam_select0" href="#clientQuestionModal"
                                    data-toggle="modal">
                            ...
                            <div class="visual-picker visual-picker has-peek">
                                ...
                                <!-- .visual-picker-figure -->
                                <label class="visual-picker-figure" for="exam_select1" href="#clientQuestionModal"
                                    data-toggle="modal">
                                    <!-- .visual-picker-content -->
                        ...
                        <script>
                            $(document).ready(function() {
                                $('input[name="exam_select"]').change(function() {
                ...
                <!--  Model  -->
                <div class="modal fade show has-shown" id="clientQuestionModal" tabindex="-1" user_role="dialog"
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <div class="table-responsive">
                                            ...
                                            <table id="exam1" class="table w3-hoverable showexam"
                                                style="width:100% display:none;">
                                                <thead>
                                                    <tr class="bg-infohead">
                                                        ...
                                                        <tr>
                                                            @if (in_array($question->question_status, [1]))
                                                                ...
                                                                <td><select id="{{ $question->lesson_id }}"
                                                                        ...
                                                                        data-toggle="select2"
                                                                        data-placeholder="จำนวนข้อสอบ"
                                                                        data-allow-clear="false"
                                                                        data-select2-id="randomdata0" tabindex="-1"
                                                                        aria-hidden="true">
