    ...
    <script src="{{ asset('/javascript/Highcharts-6.0.7/code/modules/accessibility.js') }}"></script>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <div class="form-actions mb-2">
                    <a class="btn btn-lg btn-success ml-auto mr-4 text-white" href=""><i class="fa fa-file"></i>
                        Exoprt CSV</a>
                </div>
                        ...
                        <td colspan="2" class="text-left" align="left">
                            <div class="container">
                                ...
                                <ul class="list-icons mb-3 ">
                                    <li><span class="list-icon"><span class="fas fa-comment-alt text-success"></span></span>
                                        -
                                    </li>
                                </ul>
                            </div>
        ...
        <header class="page-title-bar">
            ...
            <button type="button" class="btn btn-success btn-floated btn-addwms"
                onclick="window.location='{{ route('questionpagecreate', [$depart, 'survey_id' => $sur]) }}'"
