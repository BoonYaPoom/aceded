...
@section('contentdepartment')
    ...
    <form action="{{route('class_store',[$depart,'course_id' => $cour])}}" autocomplete="off" id="formclassroom"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="class_name" name="class_name"
                                placeholder="รุ่น/กลุ่มเรียน" required="" value="">
                        </div>
                        <div class="form-group">
