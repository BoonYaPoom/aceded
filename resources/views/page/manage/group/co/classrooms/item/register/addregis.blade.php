...
@section('contentdepartment')
    ...
    <div class="page-inner">
        <!-- .page-section -->
        <form action="{{ route('saveSelectedUsers', [$depart,'course_id' => $cour, 'm' => $m]) }}" method="POST">
            @csrf
            <div class="page-section">
                ...
                <div class="card card-fluid">
                                    ...
                                    @foreach ($filteredUsers as $u => $user)
                                        @if ($user->user_role == 4)
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="user-checkbox" name="user_data[]"
                    ...
                    <script>
                        ...
                        <button class="btn btn-lg btn-primary-theme ml-auto" type="submit"><i class="fa fa-user-plus"></i>
                            เพิ่มผู้เรียน</button>
        </form>
