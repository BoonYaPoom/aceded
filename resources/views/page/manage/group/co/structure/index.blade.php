                ...
                <div class="card card-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor" data-placeholder="คำอธิบายหลักสูตร" data-height="200" name="description_th">
                                {{ $cour->description_th }}</textarea>
                        </div><!-- /.form-group -->
                        <div class="form-group">
                            <label for="description">คำอธิบายหลักสูตร (อังกฤษ)</label>
                            <textarea class="ckeditor" data-placeholder="คำอธิบายหลักสูตร" data-height="200" name="description_en">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor" data-placeholder="คุณสมบัติผู้เข้าอบรม" data-height="200" name="qualification_th">
                                    {{ $cour->qualification_th }}</textarea>
                        </div><!-- /.form-group -->
                        <div class="form-group">
                            <label for="qualification">คุณสมบัติผู้เข้าอบรม (อังกฤษ)</label>
                            <textarea class="ckeditor" data-placeholder="คุณสมบัติผู้เข้าอบรม" data-height="200" name="qualification_en"> 
