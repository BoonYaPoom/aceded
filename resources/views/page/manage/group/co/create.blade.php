                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control bg-muted" id="course_code" name="course_code"
                                placeholder="รหัสหลักสูตร" required="" value="ACED (Running number)" readonly>
                        </div><!-- /.form-group -->
                        @error('course_code')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="course_th" name="course_th"
                                placeholder="ชื่อหลักสูตร (ไทย)" required="" value="">
                        </div><!-- /.form-group -->
                        @error('course_th')
                            <span class="badge badge-warning">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="form-group">
                            <label for="course_en">ชื่อหลักสูตร (อังกฤษ) </label> <input type="text" class="form-control"
                                id="course_en" name="course_en" placeholder="ชื่อหลักสูตร (อังกฤษ)" value="">
                        </div><!-- /.form-group -->
                        <div class="form-group">
                        ...
                        <!-- .form-group -->
                        <div class="form-group">
                            <label for="course_status">สถานะหลักสูตร </label> <label
                                class="switcher-control switcher-control-success switcher-control-lg"><input
                                    type="checkbox" class="switcher-input" name="course_status" id="course_status"
                                    value="1"> <span class="switcher-indicator"></span> <span
                                    class="switcher-label-on">ON</span> <span
                                    class="switcher-label-off text-red">OFF</span></label>
                        </div><!-- /.form-group -->
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-none">
                                    <!-- .form-group -->
                                    <div class="form-group">
                                        <div class="control-label" for="age">อายุบุคลากร</label> <select
                                    ...
                                    <div class="col-md-6  d-none">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="position">ตำแหน่ง</label> <select
                                                ...
                                                data-toggle="select2" data-placeholder="ตำแหน่ง" data-allow-clear="false"
                                                multiple></select>
                                        </div><!-- /.form-group -->
                                    </div><!-- /grid column -->
                                    <!-- grid column -->
                            ...
                            <div class="row">
                                            ...
                                            <div class="card card-figure">
                                                ...
                                                <figure class="figure">
                                                    ...
                                                    <figcaption class="figure-caption">
                                                        ...
                                                        <p class="text-muted mb-0 ">
                                                        <div class="custom-control custom-radio text-center"><input type="radio" class="custom-control-input" name="templete_certificate" id="certificate7" value="7"> <label class="custom-control-label" for="certificate7"></label></div>
                                                        </p>
                                                    </figcaption><!-- /.figure-caption -->
                                                </figure><!-- /.card-figure -->
                                            </div><!-- /.card -->
                                ...
                                <fieldset>
                                    <legend>ข้อมูลใบประกาศนียบัตร</legend>
                                           <div class="form-group">
                                        <label for="cert_subject">ชื่อหลักสูตร
                                                  <small class="form-text text-muted">ถ้าไม่ระบุ จะดึงชื่อหลักสูตรมาแสดงบนใบประกาศ</small>
                                        </label>
                                        <input type="text" class="form-control" id="cert_subject" name="cert_subject" placeholder="ชื่อหลักสูตร" value="">
                                    </div>
                                    <div class="row ">
                                        <div class="col-md-6">
                                            <div class="form-group">
