            ...
            <div class="card card-fluid">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="drop1" class="col-md-3 text-left mt-1">หน่วยงาน</label>
                            <select id="drop1" name="drop1" class="form-control form-control-sm"
                                ...
                                @foreach ($department as $depart)
                                    <option value="{{ $depart->department_id }}"> {{ $depart->name_th }} </option>
                                @endforeach
                            </select>
                        </div>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('#drop1').on('change', function() {
                                                ...
                                                console.log('department_id:', selectedValue);

                                                // ใช้ Ajax เพื่อดึงข้อมูลผู้ใช้จาก Laravel
                                                $.ajax({
                                                    url: "{{ route('fetchUsersByDepartment') }}",
                                                    type: "GET",
                                                    data: {
                                                    ...
                                                    success: function(data) {
                                                        $('#datatable').DataTable().clear().rows.add(data.users).draw();
