                ...
                <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <select id="role" name="role" class="form-control form-control-sm"
                                    ...
                                    <option value="5" {{ request('role') == '5' ? 'selected' : '' }}>ผู้เยี่ยมชม</option>
                                    <option value="1" {{ request('role') == '1' ? 'selected' : '' }}>ผู้ดูแลระบบ</option>
                                </select>
                            </div>
                    ...
                    <script>
                        function filterResults() {
                            ...
                            if (roleValue) {
                                window.location.href = baseUrl + '/' + roleValue;
                            } else {
