    ...
    <div class="page-inner">
        ...
        <div class="page-section">
            ...
            <div class="card card-fluid">
                ...
                <div class="card-header bg-muted"><a href="{{ route('manage', ['department_id' => $depart]) }}"
                        ...
                        style="text-decoration: underline;">ข่าว/กิจกรรม</a> / <i> กิจกรรม</i></div>
                <div class="card-body">
                                            ...
                                            <td class="align-middle">
                                                <a
                                                    ...
                                                    <i class="fas far fa-list-alt fa-lg text-info" data-toggle="tooltip"
                                                        title="ข้อมูล"></i></a>
                                                <a
                                                    href="{{ route('actedit', ['department_id' => $depart, 'category_id' => $item->category_id]) }}"><i
        ...
        <header class="page-title-bar">
            ...
            <button type="button" class="btn btn-success btn-floated btn-addwms"
                onclick="window.location='{{ route('createact', ['department_id' => $depart]) }}'" data-toggle="tooltip"
                title="เพิ่ม">
