    ...
    <div class="page-inner">
                            ...
                            <tbody>
                                ...
                                @if($item->category_type == 1 )
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('catpage', ['department_id' => $depart,'category_id' => $item->category_id]) }}">
                                                <i class="fas far fa-list-alt fa-lg text-info" data-toggle="tooltip"
                                                    title="ข้อมูล"></i></a>
                                            <a href="{{ route('evenedit', ['department_id' => $depart,'category_id' => $item->category_id]) }}"><i
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-warning"
                                                                id="confirmdelete"><i class="fas fa-trash-alt fa-lg "></i>
                                                                Delete Item</button>
        ...
        <header class="page-title-bar">
            ...
            <button type="button" class="btn btn-success btn-floated btn-addwms"
                onclick="window.location='{{ route('evencreate',['department_id' => $depart]) }}'" data-toggle="tooltip" title="เพิ่ม">
