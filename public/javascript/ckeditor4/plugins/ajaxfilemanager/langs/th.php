<?php
	...
	define('MENU_SELECT', 'เลือก');
	define('MENU_DOWNLOAD', 'ดาวน์โหลด');
	define('MENU_PREVIEW', 'แสดงตัวอย่าง');
	define('MENU_RENAME', 'เปลี่ยนชื่อ');
	define('MENU_EDIT', 'แก้ไข');
	define('MENU_CUT', 'ตัด');
	define('MENU_COPY', 'คัดลอก');
	define('MENU_DELETE', 'ลบ');
	define('MENU_PLAY', 'เล่น');
	define('MENU_PASTE', 'วาง');
	
	//Label
		//Top Action
		define('LBL_ACTION_REFRESH', 'รีเฟรช');
		define('LBL_ACTION_DELETE', 'ลบ');
		define('LBL_ACTION_CUT', 'ตัด');
		define('LBL_ACTION_COPY', 'คัดลอก');
		define('LBL_ACTION_PASTE', 'วาง');
		define('LBL_ACTION_CLOSE', 'ปิด');
		define('LBL_ACTION_SELECT_ALL', 'เลือกทั้งหมด');
		//File Listing
	define('LBL_NAME', 'ชื่อ');
	define('LBL_SIZE', 'ขนาด');
	define('LBL_MODIFIED', 'แก้ไขเมื่อ');
		//File Information
	define('LBL_FILE_INFO', 'ข้อมูลไฟล์:');
	define('LBL_FILE_NAME', 'ชื่อ:');	
	define('LBL_FILE_CREATED', 'สร้างเมื่อ:');
	define('LBL_FILE_MODIFIED', 'แก้ไขเมื่อ:');
	define('LBL_FILE_SIZE', 'ขนาดไฟล์:');
	define('LBL_FILE_TYPE', 'ประเภทไฟล์:');
	define('LBL_FILE_WRITABLE', 'เขียนได้?');
	define('LBL_FILE_READABLE', 'อ่านได้?');
		//Folder Information
	define('LBL_FOLDER_INFO', 'ข้อมูลโฟลเดอร์');
	define('LBL_FOLDER_PATH', 'โฟลเดอร์:');
	define('LBL_CURRENT_FOLDER_PATH', 'โฟลเดอร์ปัจจุบัน:');
	define('LBL_FOLDER_CREATED', 'สร้างเมือ:');
	define('LBL_FOLDER_MODIFIED', 'แก้ไขเมื่อ:');
	define('LBL_FOLDER_SUDDIR', 'โฟลเดอร์ย่อย:');
	define('LBL_FOLDER_FIELS', 'ไฟล์:');
	define('LBL_FOLDER_WRITABLE', 'เขียนได้?');
	define('LBL_FOLDER_READABLE', 'อ่านได้?');
	define('LBL_FOLDER_ROOT', 'โฟลเดอร์');
		//Preview
	define('LBL_PREVIEW', 'แสดงตัวอย่าง');
	define('LBL_CLICK_PREVIEW', 'คลิกเพื่อแสดงตัวอย่าง.');
	//Buttons
	define('LBL_BTN_SELECT', 'เลือก');
	define('LBL_BTN_CANCEL', 'ยกเลิก');
	define('LBL_BTN_UPLOAD', 'อัพโหลด');
	define('LBL_BTN_CREATE', 'สร้าง');
	define('LBL_BTN_CLOSE', 'ปิด');
	define('LBL_BTN_NEW_FOLDER', 'โฟลเดอร์ใหม่');
	define('LBL_BTN_NEW_FILE', 'ไฟล์ใหม่');
	define('LBL_BTN_EDIT_IMAGE', 'แก้ไข');
	define('LBL_BTN_VIEW', 'เลือกดู');
	define('LBL_BTN_VIEW_TEXT', 'ข้อความ');
	define('LBL_BTN_VIEW_DETAILS', 'รายละเอียด');
	define('LBL_BTN_VIEW_THUMBNAIL', 'รูปขนาดย่อ');
	define('LBL_BTN_VIEW_OPTIONS', 'แสดงใน:');
	//pagination
	define('PAGINATION_NEXT', 'ถัดไป');
	define('PAGINATION_PREVIOUS', 'ก่อนหน้า');
	define('PAGINATION_LAST', 'หน้าสุดท้าย');
	define('PAGINATION_FIRST', 'หน้าแรก');
	define('PAGINATION_ITEMS_PER_PAGE', 'แสดง %s รายการ/หน้า');
	define('PAGINATION_GO_PARENT', 'ไปยังโฟล์เดอร์');
	//System
