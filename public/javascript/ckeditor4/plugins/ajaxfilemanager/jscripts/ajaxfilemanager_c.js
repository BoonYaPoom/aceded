...
{ switch(files[num].cssClass)
{ case 'filePicture':
$('w<a id="thumbUrl' + num + '" rel="thumbPhotos" href="' + files[num].path + '"><img src="' + appendQueryString(getUrl('thumbnail', false, false), 'path=' + files[num].path, ['path']) + '" id="thumbImg' + num + '"></a>').appendTo('#dt' + num); break; case 'fileFlash':
break; case 'fileVideo':
break; case 'fileMusic':
break; default:
}
...
{infourl=info.url; /*infourl=infourl.substring(infourl.indexOf('upload-files'),infourl.length); */selectFile(infourl);} ); $('#returnCurrentUrl').show();}else
